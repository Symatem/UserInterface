...
module.exports = function(element) {
    ...
    this.fetchResource('../public/js/Symatem.wasm', 'arraybuffer').then(function(arraybuffer) {
        new Symatem(new Uint8Array(arraybuffer)).then(function(symatemInstance) {
            ...
            this.codeInput.onclick = function() {
                const code = prompt('Edit content');
                ...
                this.hideAllSymbols();
                this.loadFromText();
                Prism.highlightElement(this.codeInput);
            }.bind(this);
...
module.exports.prototype.loadFromText = function() {
    const result = this.symatem.deserializeBlob(this.codeInput.innerText);
